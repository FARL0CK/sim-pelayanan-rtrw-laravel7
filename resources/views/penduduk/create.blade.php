                                ...
                                <div class="form-group col-lg-4 col-md-6">
                                    ...
                                    <select class="form-control @error('tempat_dilahirkan_id') is-invalid @enderror"
                                        ...
                                        @foreach ($tempat_dilahirkan as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('tempat_dilahirkan_id') == $item->id ? 'selected="true"' : '' }}>
                                                {{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select style="width: 100%;"
                                        ...
                                        @foreach ($pekerjaan as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('pekerjaan_id') == $item->id ? 'selected="true"' : '' }}>
                                                {{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                    @error('pekerjaan_id')
                            ...
                            <div class="row">
                                <div class="form-group col-lg-4 col-md-6">
                                    ...
                                    <select class="form-control @error('kewarganegaraan') is-invalid @enderror"
                                        ...
                                        <option value="1" {{ old('kewarganegaraan') == 1 ? 'selected="true"' : '' }}>
                                            WNI</option>
                                        <option value="2" {{ old('kewarganegaraan') == 2 ? 'selected="true"' : '' }}>
                                            WNA</option>
                                        <option value="3" {{ old('kewarganegaraan') == 3 ? 'selected="true"' : '' }}>
                                ...
                                <div class="form-group col-lg-8 col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nomor_kitas_atau_kitap') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea class="form-control @error('alamat_sebelumnya') is-invalid @enderror" name="alamat_sebelumnya"
                                        id="alamat_sebelumnya" placeholder="Masukkan Alamat Sebelumnya ...">{{ old('alamat_sebelumnya') }}</textarea>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea class="form-control @error('alamat_sekarang') is-invalid @enderror" name="alamat_sekarang"
                                        id="alamat_sekarang" placeholder="Masukkan Alamat Sekarang ...">{{ old('alamat_sekarang') }}</textarea>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-4 col-md-6">
                                    ...
                                    <select class="form-control @error('status_perkawinan_id') is-invalid @enderror"
                                        ...
                                        @foreach ($status_perkawinan as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('status_perkawinan_id') == $item->id ? 'selected="true"' : '' }}>
                                                {{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nomor_akta_perceraian') }}">
                                ...
                                <div class="form-group col-lg-4 col-md-6">
                                    ...
                                    <select class="form-control @error('darah_id') is-invalid @enderror" name="darah_id"
                                        ...
                                        @foreach ($darah as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('darah_id') == $item->id ? 'selected="true"' : '' }}>
                                ...
                                <div class="form-group col-lg-4 col-md-6">
                                    ...
                                    <select class="form-control @error('jenis_cacat_id') is-invalid @enderror"
                                        ...
                                        @foreach ($jenis_cacat as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('jenis_cacat_id') == $item->id ? 'selected="true"' : '' }}>
                                                {{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-lg-4 col-md-6">
                                    ...
                                    <select class="form-control @error('sakit_menahun_id') is-invalid @enderror"
                                        ...
                                        @foreach ($sakit_menahun as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('sakit_menahun_id') == $item->id ? 'selected="true"' : '' }}>
                                                {{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-lg-4 col-md-6">
                                    ...
                                    <select class="form-control @error('asuransi_id') is-invalid @enderror"
                                        ...
                                        @foreach ($asuransi as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('asuransi_id') == $item->id ? 'selected="true"' : '' }}>
                                                {{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                    @error('asuransi_id')
        ...
        function option(value) {
            ...
            $.get(baseURL + "/akseptor-kb/" + value, function(response) {
                ...
                $.each(response, function(key, item) {
                    option +=
                        `<option value="${item.id}" ${"{{ old('akseptor_kb_id') }}" == item.id ? 'selected' : ''}>${item.nama}</option>`;
                });
