...
class CetakSuratController extends Controller
{
    ...
    public function store(Request $request, $id)
    {
        ...
        if ($surat->tampilkan == 1) {
            ...
            $path = public_path('storage/gambar/ttdd.png');
            $image = Image::make($path);
            $ttd = (string) Image::make($image)->encode('data-url');
            ...
            $pdf = PDF::loadView('cetak-surat.show', compact('surat', 'kode_desa', 'desa', 'isian', 'logo', 'ttd', 'tanggal', 'nomor'))->setPaper(array(0, 0, 609.449, 935.433));
