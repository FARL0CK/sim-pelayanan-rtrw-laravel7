...
@section('styles')
    <meta name="description"
        content="Statistik Penduduk Desa {{ App\Desa::find(1)->nama_desa }}, Kecamatan {{ App\Desa::find(1)->nama_kecamatan }}, Kabupaten {{ App\Desa::find(1)->nama_kabupaten }}.">
        ...
        <div class="header-body text-center mt-5 mb-3">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-6 border-bottom">
                    ...
                    <p class="">Statistik Penduduk RW 22 Desa {{ $desa->nama_desa }}, masyarakat dapat dengan mudah
                        mengetahui informasi mengenai statistik penduduk RW 22 desa {{ $desa->nama_desa }}.</p>
                </div>
            </div>
        </div>
        <div class="row">
