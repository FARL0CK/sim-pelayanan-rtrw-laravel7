...
<head>
    <link rel="icon" href="{{ url(Storage::url($desa->logo)) }}">
    ...
    <div style="margin-top: 1cm; margin-bottom:0.5cm; margin-left: 1cm; margin-right: 1cm;">
        <div style="height:100px;width:100%; margin-bottom: 1rem">
            ...
            <div class="lh-20px" style="text-align: center">
                <span style="font-size: 14pt; font-weight: bold">PEMERINTAHAN KABUPATEN
                    {{ Str::upper($desa->nama_kabupaten) }}</span><br>
                <span style="font-size: 14pt; font-weight: bold">KECAMATAN
        ...
        @if ($surat->perihal == 1)
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td>: {{ $surat->kode_surat }} / {{ $nomor }} / {{ $kode_desa }} /
                                {{ date('Y') }}</td>
                        </tr>
                        <tr>
            ...
            <div style="margin-left: 60%; width: 40%; text-align: center; float: right;">
                <p style="margin-bottom: 34px">{{ $desa->nama_desa }}, {{ $tanggal }}<br>Kepada
                    {{ $perihal[3] }}</p>
                <p>Di - {{ $perihal[4] }}</p>
            </div>
        @else
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: justify" valign="top">
                                {{ $desa->ttd ? $desa->ttd->nama : $desa->nama_kepala_desa }}</td>
                        </tr>
                        <tr>
                            <td width="160px" valign="top">Jabatan</td>
                            <td width="10px" valign="top">:</td>
                            <td style="text-align: justify" valign="top">
                                {{ $desa->ttd ? $desa->ttd->jabatan : 'Kepala Desa' }}</td>
                        </tr>
                        <tr>
                            <td width="160px" valign="top">Alamat</td>
                            <td width="10px" valign="top">:</td>
                            <td style="text-align: justify" valign="top">
                                {{ $desa->ttd ? $desa->ttd->alamat : $desa->alamat_kepala_desa }}</td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div style="margin-left: 50%; width: 50%; float: right; text-align: center">
            <p style="margin-bottom: 100px; margin-top:0px">
                ...
                Ketua RW 22 {{ $desa->nama_desa }}
                <br>
                <br>
                <img style="width: 30%" src="{{ $ttd }}" alt="">
                <br>
                (wahyu hidayat)
