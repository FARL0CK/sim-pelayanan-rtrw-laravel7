    ...
    <form class="mt-4 mb-3 d-md-none">
        <div class="input-group input-group-rounded input-group-merge">
            <input type="search" name="cari" class="form-control form-control-rounded form-control-prepended"
                placeholder="cari" aria-label="cari" value="{{ request('cari') }}">
            <div class="input-group-prepend">
            ...
            <div class="col-lg-4 col-md-6 surats">
                <div class="single-service bg-white rounded shadow">
                    ...
                    <a href="{{ route('buat-surat', ['id' => $item->id, 'slug' => Str::slug($item->nama)]) }}"
                        class="btn btn-sm btn-success" title="Cetak"><i class="fas fa-print"></i> Cetak</a>
                            ...
                            <select class="form-control" type="text" id="ditandatangani" name="ditandatangani">
                                ...
                                @foreach ($pemerintahan_desa as $item)
                                    <option value="{{ $item->id }}"
                                        {{ $desa->pemerintahan_desa_id == $item->id ? 'selected' : '' }}>
