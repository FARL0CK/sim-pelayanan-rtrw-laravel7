<div class="container-fluid">
    ...
    <a class="text-center pt-0" href="{{ route('home.index') }}">
        <h1 class="text-primary font-weight-900 text-uppercase">Simapel RW/RT</h1>
    </a>
    <!-- User -->
            ...
            <div class="row">
                <div class="col-6 collapse-brand">
                    <a href="{{ route('home.index') }}">
                        <h1 class="text-primary"><b>Simpel RT/RW</b></h1>
                    </a>
                </div>
            ...
            @if (count($peran_menu->peran_menu_submenu) > 0)
                <ul class="navbar-nav">
                    @foreach ($peran_menu->peran_menu_submenu as $item)
                        <li class="nav-item">
                            <a class="nav-link @if (Request::segment(1) == $item->submenu->url) active @endif"
                                href="{{ url($item->submenu->url) }}">
