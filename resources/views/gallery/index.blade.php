                    ...
                    <div class="card shadow h-100">
                        <div class="card-header border-0">
                            <div
                                ...
                                <div class="mb-3">
                                    <input type="checkbox" id="check-all" title="centang semua" class="mb-1"
                                        data-toggle="tooltip" style="transform: scale(1.5)">
                                    <button type="button" id="delete-check" class="btn btn-danger mb-1"><i
                                            class="fas fa-trash"></i> Hapus Terpilih</button>
                                    <a href="#video-modal" data-toggle="modal" class="btn btn-success mb-1"><i
                                            class="fas fa-video mr-2"></i> Pengaturan Video</a>
                                    <a href="#tambah-gambar" data-toggle="modal" class="btn btn-primary mb-1"><i
    ...
    <div id="loading" class="row">
        @for ($i = 0; $i < 3; $i++)
            <div class="col-lg-4 col-md-6 mb-3 img-scale-up">
                <a href="{{ url('img/img-lazy-loading.gif') }}" data-fancybox><img
                        src="{{ url('img/img-lazy-loading.gif') }}" class="img-fluid" alt="Loading"></a>
            </div>
        @endfor
    </div>
    ...
    <script>
        ...
        $(window).scroll(function() { //detect page scroll
            if ($(window).scrollTop() + $(window).height() >= $(document).height() -
                70) { //if user scrolled from top to bottom of the page
                if (dataExists) {
