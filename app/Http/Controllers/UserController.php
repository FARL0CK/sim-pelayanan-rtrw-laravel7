...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        User::create($data);
        return redirect()->route('user.index')->with('success', 'User berhasil ditambahkan. password login: "12345678"');
    }
    ...
    public function reset_password(User $user)
    {
        ...
        $user->save();
        return back()->with('success', 'Password berhasil Direset. password login: "12345678');
    }
}
