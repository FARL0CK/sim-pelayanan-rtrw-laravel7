                    ...
                    <form autocomplete="off" action="{{ route('surat.store') }}" method="post">
                        ...
                        <div class="pl-lg-4">
                                ...
                                <select name="kode_surat" id="kode_surat" class="form-control">
                                    ...
                                    @foreach (App\KodeSurat::all() as $key => $item)
                                        <option value="{{ $item->kode }}">{{ $item->kode }} - {{ $item->nama }}
                                            {{ $item->uraian != '-' ? '- ' . $item->uraian : '' }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="persyaratan"
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="text-right mt-3">
                                                <input type="checkbox" name="tampil[]" value="1"
                                                    style="transform: scale(1.5); margin-right: 15px" data-toggle="tooltip"
                                                    title="Centang untuk ditampilkan pada form buat surat">
                                                <input type="hidden" name="tampilkan[]" value="0">
                                                <a class="bantuan mb-1 mr-2" href="{{ url('img/bantuan-paragraf.png') }}"
                                                    data-fancybox><i class="fas fa-question-circle text-blue"
                                                        title="Bantuan" data-toggle="tooltip"></i></a>
                                                <button class="btn btn-sm btn-success mb-1 atas-isian" data-toggle="tooltip"
                                                    title="Pindahkan Ke Atas" type="button"><i
                                                        class="fas fa-arrow-up"></i></button>
                                                <button class="btn btn-sm btn-success mb-1 bawah-isian"
                                                    data-toggle="tooltip" title="Pindahkan Ke Bawah" type="button"><i
                                                        class="fas fa-arrow-down"></i></button>
                                                <button class="btn btn-sm btn-primary mb-1 tambah-isian"
                                                    data-toggle="tooltip" title="Tambah Isian" type="button"><i
                                                        class="fas fa-plus"></i></button>
                                                <button class="btn btn-sm btn-danger mb-1 hapus-isian"
                                                    data-toggle="tooltip" title="Hapus Isian Ini" type="button"><i
                        ...
                        <div class="pl-lg-4">
                            <a class="btn btn-primary btn-sm" href="{{ url('img/bantuan-paragraf-kalimat-isian.png') }}"
                                data-fancybox><i class="fas fa-question-circle" data-toggle="tooltip"></i> Bantuan</a>
