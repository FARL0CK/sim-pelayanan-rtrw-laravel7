                    ...
                    <div class="card shadow h-100">
                        <div class="card-header border-0">
                            <div
                                ...
                                <div class="mb-3">
                                    <a href="{{ route('penduduk.edit', $penduduk) }}" class="btn btn-success"
                                        data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
                                    <a class="btn btn-danger hapus-data" data-nama="{{ $penduduk->nama }}"
                                        data-action="{{ route('penduduk.destroy', $penduduk) }}" data-toggle="tooltip"
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2 col-md-3">
                            <div class="form-group text-center">
                                ...
                                <img class="mw-100 upload-image" style="max-height: 300px"
                                    src="{{ $penduduk->foto ? asset(Storage::url($penduduk->foto)) : asset('storage/noavatar.png') }}"
                                    alt="foto">
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped">
                            ...
                            <tr>
                                <th colspan="3" class="bg-primary text-white">Data Kelahiran</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="5px">:</td>
                                <td>{{ $penduduk->tanggal_lahir ? tgl(date('Y-m-d', strtotime($penduduk->tanggal_lahir))) : '-' }}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th colspan="3" class="bg-primary text-white">Pendidikan Dan Pekerjaan</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th colspan="3" class="bg-primary text-white">Data Kewarganegaraan</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th colspan="3" class="bg-primary text-white">Data Orang Tua</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th colspan="3" class="bg-primary text-white">Alamat</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th colspan="3" class="bg-primary text-white">Status Perkawinan</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="5px">:</td>
                                <td>{{ $penduduk->tanggal_perkawinan ? tgl(date('Y-m-d', strtotime($penduduk->tanggal_perkawinan))) : '-' }}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="5px">:</td>
                                <td>{{ $penduduk->tanggal_perceraian ? tgl(date('Y-m-d', strtotime($penduduk->tanggal_perceraian))) : '-' }}
                                </td>
                            </tr>
                            <tr>
                                <th colspan="3" class="bg-primary text-white">Data Kesehatan</th>
                            </tr>
                            <tr>
