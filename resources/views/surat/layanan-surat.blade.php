        ...
        <div class="header-body text-center mt-5 mb-5">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-6">
                    ...
                    <p class="">Dengan menggunakan layanan surat website SIMAPEL RW/RT Desa {{ $desa->nama_desa }},
                        masyarakat
                        dapat dengan mudah membuat beberapa surat keterangan berikut ini secara online.</p>
                    <form class="navbar-search">
                        <div class="form-group mb-0">
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control" placeholder="Cari Surat ...." type="text" name="cari"
                                    id="cari" value="{{ request('cari') }}">
                            </div>
                        </div>
                    </form>
                </div>
